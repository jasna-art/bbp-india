...
const BRAND_LOGOS = [
  ...
  { name: "Skinnove", file: "skin.png" },
  { name: "Woodon", file: "wood.png" },
  { name: "Veda of Wellness", file: "ved.png" },
   { name: "Dew & Drift", file: "dew.png" },
   { name: "hei", file: "giss.png" },
  ...
  { name: "RKG", file: "rkg.png" },
   { name: "Zukti", file: "zuk.png" },
    { name: "Eduport", file: "eduport.png" },
   { name: "Eduport", file: "rgi.png" },
  { name: "Eduport", file: "alan.png" },
  { name: "Heim", file: "hei.png" },
  { name: "Harman Motors", file: "harm.png" },
  { name: "Eduport", file: "swayam.png" },
